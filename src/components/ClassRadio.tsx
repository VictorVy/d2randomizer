const ClassRadio = () => {
    return (
        <div className="m-2 flex max-w-min items-center bg-black bg-opacity-30 p-2">
            <label className="px-2">
                <input className="peer absolute h-0 w-0" type="radio" name="class-radio" value="titan" />
                <svg
            ...
            <label className="px-2">
                <input className="peer absolute w-0" type="radio" name="class-radio" defaultChecked />
                <svg
                    className="fill-white opacity-50 peer-checked:opacity-90 peer-hover:opacity-90 peer-active:opacity-100"
                    viewBox="0 0 32 32"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <label className="px-2">
                <input className="peer absolute w-0" type="radio" name="class-radio" />
                <svg
                    className="fill-white opacity-50 peer-checked:opacity-90 peer-hover:opacity-90 peer-active:opacity-100"
                    viewBox="0 0 32 32"
                    xmlns="http://www.w3.org/2000/svg"
