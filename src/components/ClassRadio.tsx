const ClassRadio = () => {
    return (
        <div className="flex">
            <label>
                <input className="pointer-events-none fixed opacity-0" type="radio" name="class-radio" value="titan" />
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="38">
                    <path
            ...
            <label>
                <input type="radio" name="class-radio" defaultChecked />
            ...
            <label>
                ...
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="44">
                    <path
